...
const CadastrarDocumentoDeIdentificação= async()=>{
  
}
  const OnSubmit = async ( data) => {

    await api.post('incricao',)
  };
  ...
  return (
    <>
      ...
      <FormContainer>
        <Form onSubmit={()=>{}} title={'Inscrição'} onChange={HandleOnChange} dataGroup={dataGroup}></Form>
      </FormContainer>
      <Footer></Footer>
    </>
  );
